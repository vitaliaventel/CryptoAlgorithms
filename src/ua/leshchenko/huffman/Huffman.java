...
public final class Huffman {
    ...
    private static HuffmanNode deserializeTree() throws FileNotFoundException, IOException, ClassNotFoundException {
        try (ObjectInputStream oisBranch = new ObjectInputStream(new FileInputStream("./data/tree"))) {
            try (ObjectInputStream oisChar = new ObjectInputStream(new FileInputStream("./data/char"))) {
    ...
    private static String decodeMessage(HuffmanNode node) throws FileNotFoundException, IOException, ClassNotFoundException {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("./data/encodedMessage"))) {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, ClassNotFoundException {
        Huffman.compress("I love Salesforce");
        String result = Huffman.expand();
